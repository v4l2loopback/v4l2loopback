...
It allows you to create virtual video devices. Standard V4L2 
applications will recognize these devices as standard video sources, but
 instead of grabbing input from a capture card, another application 
provides the video. This is useful for a variety of applications, 
including video effects use or adding streaming capabilities by 
inserting GStreamer into the loopback devices.
